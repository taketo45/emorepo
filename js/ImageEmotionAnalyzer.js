// import { VISION_API_KEY } from './AuthkeysModule.js';
...
export class ImageEmotionAnalyzer {
    ...
    async analyzeImageFile(file) {
        const endpoint = `${this.config.endpoint}?key=${this.config.apiKey}`;
...
// // 画像分析関連の機能を管理するモジュール
// export const ImageEmotionAnalyzer = {
//     // 画像分析の実行
//     async analyzeFaceAndEmotions(imageData) {
//         try {
//             let fileToAnalyze;
